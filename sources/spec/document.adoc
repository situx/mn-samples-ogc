...
include::sections/08-title.adoc[]
...
include::sections/ab_functions_summary.adoc[]

include::sections/ac_examples.adoc[]

include::sections/ad_shacl_shapes.adoc[]

include::sections/ae_alignments.adoc[]

include::sections/af_cql_geosparql_mapping.adoc[]

include::sections/ag_revision_history.adoc[]

include::sections/az_bibliography.adoc[]
