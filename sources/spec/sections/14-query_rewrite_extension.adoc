...
[requirement,type="class",label="http://www.opengis.net/spec/geosparql/1.0/req/query-rewrite-extension/sf-query-rewrite",obligation="requirement"]
[%unnumbered]
|===
...
[requirement,type="class",label="http://www.opengis.net/spec/geosparql/1.0/req/query-rewrite-extension/rcc8-query-rewrite",obligation="requirement"]
[%unnumbered]
|===
| *Req {counter:req}* Basic graph pattern matching shall use the semantics defined by the RIF Core Entailment Regime <<SPARQLENT>> for the RIF rules <<RIFCORE>> 
