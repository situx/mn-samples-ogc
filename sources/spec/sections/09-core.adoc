...
[%unnumbered]
[requirement,label="http://www.opengis.net/spec/geosparql/1.0/req/core/sparql-protocol",identifier=http://www.opengis.net/spec/geosparql/1.0/req/core/sparql-protocol]
==== *Req {counter:req}*
