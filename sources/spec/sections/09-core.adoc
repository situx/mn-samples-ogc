...
[%unnumbered]
[requirement,identifier="http://www.opengis.net/spec/geosparql/1.0/req/core/sparql-protocol"]
==== 
*Req {counter:req}*
...
[requirement,identifier=http://www.opengis.net/spec/geosparql/1.0/req/core/spatial-object-class]
[%unnumbered]
==== 
*Req {counter:req}*
