...
[%unnumbered]
[requirement,label="http://www.opengis.net/spec/geosparql/1.0/req/core/sparql-protocol",identifier=http://www.opengis.net/spec/geosparql/1.0/req/core/sparql-protocol,obligation="requirement"]
==== *Req {counter:req}*
...
[requirement,label="http://www.opengis.net/spec/geosparql/1.0/req/core/spatial-object-class",identifier=http://www.opengis.net/spec/geosparql/1.0/req/core/spatial-object-class,obligation="requirement"]
[%unnumbered]
==== *Req {counter:req}*
