...
[requirement,identifier="/req/core/sparql-protocol"]
==== 
*Req {counter:req}*
...
[requirement,label="/req/core/feature-collection-class"]
====
*Req {counter:req}* 
...
[requirement,label="/req/core/spatial-object-properties"]
====
*Req {counter:req}* 
