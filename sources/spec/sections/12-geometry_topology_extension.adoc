...
[requirement,type="class",label="http://www.opengis.net/spec/geosparql/1.0/req/geometry-topology-extension/relate-query-function",obligation="requirement"]
[%unnumbered]
|===
...
[requirement,type="class",label="http://www.opengis.net/spec/geosparql/1.0/req/geometry-topology-extension/sf-query-functions",obligation="requirement"]
[%unnumbered]
|===
| *Req {counter:req}* Implementations shall support 
...
[requirement,type="class",label="http://www.opengis.net/spec/geosparql/1.0/req/geometry-topology-extension/eh-query-functions",obligation="requirement"]
[%unnumbered]
|===
| *Req {counter:req}* Implementations shall support 
...
[requirement,type="class",label="http://www.opengis.net/spec/geosparql/1.0/req/geometry-topology-extension/rcc8-query-functions",obligation="requirement"]
[%unnumbered]
|===
| *Req {counter:req}* Implementations shall support 
