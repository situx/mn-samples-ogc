...
This OGC document provides the formal specification of GeoSPARQL, a semantic web standard enabling the representation and querying of geospatial data on the Semantic Web. It consists of vocabularies to represent geospatial data, SHACL shapes to validate geospatial data provided in the GeoSPARQL vocabulary and various extensions to the SPARQL query languages for processing geospatial data. 
