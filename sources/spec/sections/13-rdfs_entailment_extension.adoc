...
[requirement,type="class",label="http://www.opengis.net/spec/geosparql/1.0/req/rdfs-entailment-extension/bgp-rdfs-ent",obligation="requirement"]
[%unnumbered]
|===
...
[requirement,type="class",label="http://www.opengis.net/spec/geosparql/1.0/req/rdfs-entailment-extension/wkt-geometry-types",obligation="requirement"]
[%unnumbered]
|===
...
[requirement,type="class",label="http://www.opengis.net/spec/geosparql/1.0/req/rdfs-entailment-extension/gml-geometry-types",obligation="requirement"]
[%unnumbered]
|===
