...
[requirement,type="class",label="http://www.opengis.net/spec/geosparql/1.0/req/topology-vocab-extension/sf-spatial-relations",obligation="requirement"]
[%unnumbered]
|===
...
|[[geof:sfEquals]]equals | http://www.opengis.net/ont/geosparql#sfEquals[`geo:sfEquals`] | <<Class: geo:SpatialObject, `geo:SpatialObject`>> | `All` | `(TFFFTFFFT)`
|[[geof:sfDisjoint]]disjoint | http://www.opengis.net/ont/geosparql#sfDisjoint[`geo:sfDisjoint`] | <<Class: geo:SpatialObject, `geo:SpatialObject`>> | `All` | `+(FF**FF****)+`
|[[geof:sfIntersects]]intersects | http://www.opengis.net/ont/geosparql#sfIntersects[`geo:sfIntersects`] | <<Class: geo:SpatialObject, `geo:SpatialObject`>> | `All` | `+(T******** *T******* ***T***** ****T****)+`
|[[geof:sfTouches]]touches | http://www.opengis.net/ont/geosparql#sfTouches[`geo:sfTouches`] | <<Class: geo:SpatialObject, `geo:SpatialObject`>> | `All except P/P` | `+(FT******* F**T***** F***T****)+`
|[[geof:sfWithin]]within | http://www.opengis.net/ont/geosparql#sfWithin[`geo:sfWithin`] | <<Class: geo:SpatialObject, `geo:SpatialObject`>> | `All` | `+(T*F**F***)+`
|[[geof:sfContains]]contains | http://www.opengis.net/ont/geosparql#sfContains[`geo:sfContains`] | <<Class: geo:SpatialObject, `geo:SpatialObject`>> | `All` | `+(T*****FF*)+`
|[[geof:sfOoverlaps]]overlaps | http://www.opengis.net/ont/geosparql#sfOverlaps[`geo:sfOverlaps`] | <<Class: geo:SpatialObject, `geo:SpatialObject`>> | `A/A, P/P, L/L` | `+(T*T***T**) for A/A, P/P+`; `+(1*T***T**) for L/L+`
|[[geof:sfCrosses]]crosses | http://www.opengis.net/ont/geosparql#sfCrosses[`geo:sfCrosses`] | <<Class: geo:SpatialObject, `geo:SpatialObject`>> | `P/L, P/A, L/A, L/L` | `+(T*T***T**) for P/L, P/A,
L/A+`; `+(0********) for L/L+`
|===
...
[requirement,type="class",label="http://www.opengis.net/spec/geosparql/1.0/req/topology-vocab-extension/eh-spatial-relations",obligation="requirement"]
[%unnumbered]
|===
| *Req {counter:req}* Implementations shall allow the properties 
...
|[[geof:ehEquals]]equals | http://www.opengis.net/ont/geosparql#ehEquals[`geo:ehEquals`] | <<Class: geo:SpatialObject, `geo:SpatialObject`>> | `All` | `(TFFFTFFFT)`
|[[geof:ehDisjoint]]disjoint | http://www.opengis.net/ont/geosparql#ehDisjoint[`geo:ehDisjoint`] | <<Class: geo:SpatialObject, `geo:SpatialObject`>> | `All` | `+(FF*FF****)+`
|[[geof:ehMeet]]meet | http://www.opengis.net/ont/geosparql#ehMeet[`geo:ehMeet`] | <<Class: geo:SpatialObject, `geo:SpatialObject`>> | `All except P/P` | `+(FT******* F**T***** F***T****)+`
|[[geof:ehOverlap]]overlap | http://www.opengis.net/ont/geosparql#ehOverlap[`geo:ehOverlap`] | <<Class: geo:SpatialObject, `geo:SpatialObject`>> | `All` | `+(T*T***T**)+`
|[[geof:ehCovers]]covers | http://www.opengis.net/ont/geosparql#ehCovers[`geo:ehCovers`] | <<Class: geo:SpatialObject, `geo:SpatialObject`>> | `A/A, A/L, L/L` | `+(T*TFT*FF*)+`
|[[geof:ehCoveredBy]]covered by | http://www.opengis.net/ont/geosparql#ehCoveredBy[`geo:ehCoveredBy`] | <<Class: geo:SpatialObject, `geo:SpatialObject`>> | `A/A, L/A, L/L` | `+(TFF*TFT**)+`
|[[geof:ehInside]]inside | http://www.opengis.net/ont/geosparql#ehInside[`geo:ehInside`] | <<Class: geo:SpatialObject, `geo:SpatialObject`>> | `All` | `+(TFF*FFT**)+`
|[[geof:ehContains]]contains | http://www.opengis.net/ont/geosparql#ehContains[`geo:ehContains`] | <<Class: geo:SpatialObject, `geo:SpatialObject`>> | `All` | `+(T*TFF*FF*)+`
|===
...
[requirement,type="class",label="http://www.opengis.net/spec/geosparql/1.0/req/topology-vocab-extension/rcc8-spatial-relations",obligation="requirement"]
[%unnumbered]
|===
| *Req {counter:req}* Implementations shall allow the properties 
...
|[[geof:rcc8eq]]equals | http://www.opengis.net/ont/geosparql#rcc8eq[`geo:rcc8eq`] | <<Class: geo:SpatialObject, `geo:SpatialObject`>>  | `A/A` | `(TFFFTFFFT)`
|[[geof:rcc8dc]]disconnected | http://www.opengis.net/ont/geosparql#rcc8dc[`geo:rcc8dc`] | <<Class: geo:SpatialObject, `geo:SpatialObject`>>  | `A/A` | `(FFTFFTTTT)`
|[[geof:rcc8ec]]externally connected | http://www.opengis.net/ont/geosparql#rcc8ec[`geo:rcc8ec`] | <<Class: geo:SpatialObject, `geo:SpatialObject`>>  | `A/A` | `(FFTFTTTTT)`
|[[geof:rcc8po]]partially overlapping | http://www.opengis.net/ont/geosparql#rcc8po[`geo:rcc8po`] | <<Class: geo:SpatialObject, `geo:SpatialObject`>>  | `A/A` | `(TTTTTTTTT)`
|[[geof:rcc8tppi]]tangential proper part inverse | http://www.opengis.net/ont/geosparql#rcc8tppi[`geo:rcc8tppi`] | <<Class: geo:SpatialObject, `geo:SpatialObject`>>  | `A/A`  | `(TTTFTTFFT)`
|[[geof:rcc8tpp]]tangential proper part | http://www.opengis.net/ont/geosparql#rcc8tpp[`geo:rcc8tpp`] | <<Class: geo:SpatialObject, `geo:SpatialObject`>>  | `A/A` | `(TFFTTFTTT)`
|[[geof:rcc8ntpp]]non-tangential proper part | http://www.opengis.net/ont/geosparql#rcc8ntpp[`geo:rcc8ntpp`] | <<Class: geo:SpatialObject, `geo:SpatialObject`>>  | `A/A` | `(TFFTFFTTT)`
|[[geof:rcc8ntppi]]non-tangential proper part inverse | http://www.opengis.net/ont/geosparql#rcc8ntppi[`geo:rcc8ntppi`] | <<Class: geo:SpatialObject, `geo:SpatialObject`>>  | `A/A` | `(TTTFFTFFT)`
|===
