...
====
A serialization strongly affects the geometry conceptualization. The WKT serialization aligns the geometry types with _ISO 19125 Simple Features_ <<OGCSFACA>> <<ISO19125-1>>; the GML serialization aligns the geometry types with _ISO 19107 Spatial Schema_ <<ISO19107>>.
====
...
[NOTE,keep-separate=true]
====
See the <<Recommendation for specification of units of measurement, Recommendation for specification of units of measurement>>.
====
