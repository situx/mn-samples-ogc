...
[requirement,label="/req/geometry-extension/asWKT-function"]
====
Implementations shall support <<Property: geo:asWKT, `geo:asWKT`>> as a SPARQL extension function.
====
...
[requirement,label="/req/geometry-extension/kml-literal"]
====
...
[requirement,label="/req/geometry-extension/asDGGS-function"]
====
